...
% Flag set by \setHasReferences command from JavaScript
\newif\ifhasrefs
\hasrefsfalse
\newcommand{\setHasReferences}{\hasrefstrue}
...
% Only print if hasrefs flag is set (by \setHasReferences in references.tex)
