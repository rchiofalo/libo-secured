...
\newcommand{\printEnclosureList}{%
    % DEBUG: Always show enclosure count
    \noindent\textbf{DEBUG: enclmax = \arabic{enclmax}}\\
...
% DEBUG: Test if enclosures.tex is being read
\IfFileExists{enclosures.tex}{%
    \typeout{DEBUG: enclosures.tex EXISTS}%
    \input{enclosures.tex}%
}{%
    \typeout{DEBUG: enclosures.tex NOT FOUND - using fallback}%
}
\typeout{DEBUG: After loading enclosures, enclmax = \arabic{enclmax}}
