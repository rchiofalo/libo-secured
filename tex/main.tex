...
\newcommand{\setSealType}[1]{\renewcommand{\SealType}{#1}}

% Helper to get seal filename based on type
\newcommand{\getSealFile}{%
    \ifthenelse{\equal{\SealType}{dow}}{dow-seal.png}{dod-seal.png}%
}
...
\newcommand{\printLetterhead}{%
    \begin{textblock*}{1in}(0.5in, 0.5in)%
        \IfFileExists{attachments/\getSealFile}{%
            \includegraphics[width=1in]{attachments/\getSealFile}%
        }{%
            \framebox[1in][c]{%
                \parbox{0.9in}{\centering\scriptsize Seal\\(add \getSealFile)}%
            }%
        }%
    \end{textblock*}%
